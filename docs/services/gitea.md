...
![](../static/gitea/gitea-logo.svg) Use Version Control system to collaborate and keep a copy and track of your clean code.
...
![](../static/gitea/upload-key-to-gitea.png)
